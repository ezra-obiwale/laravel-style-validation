...
export const notRegex = 'Value doesn\'t match the expected pattern';
...
export const regex = 'Value doesn\'t match the expected pattern';
...
export const typeOf = 'Value must be a $type';
